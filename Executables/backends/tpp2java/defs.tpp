...
template java_ir_type(t: TypeKind)
...
template java_ir_boxed_type(t: TypeKind)
...
template java_variant_from_json(v: VariantDef, enumName: string)
@if v.payload@
@switch v.payload@
@case Str@
...
template render_java_enum_body(e: EnumDef)
    public String _tag;
...
template render_java_enum(e: EnumDef)
class @e.name@ {
@render_java_enum_body(e)@
END

template render_java_static_enum(e: EnumDef)
static class @e.name@ {
@render_java_enum_body(e)@
END

template render_java_struct_body(s: StructDef)
    @for field in s.fields@
    public @java_ir_type(field.type)@ @field.name@;
    @end for@
...
template render_java_struct(s: StructDef)
class @s.name@ {
@render_java_struct_body(s)@
END

template render_java_static_struct(s: StructDef)
static class @s.name@ {
@render_java_struct_body(s)@
END
...
template render_java_source(input: IR)
// Generated by tpp2java — do not edit.
@for e in input.enums@
@render_java_enum(e)@
@end for@
@for s in input.structs@
@render_java_struct(s)@
@end for@
END

template render_java_types_body(input: IR)
@for e in input.enums@
@render_java_static_enum(e)@
@end for@
@for s in input.structs@
@render_java_static_struct(s)@
@end for@
END
...
template emit_java_runtime_members(ctx: RenderFunctionsInput)
...
template render_java_bundle(input: IR, ctx: RenderFunctionsInput)
// Generated by tpp2java — namespaced test bundle.

class @if ctx.namespaceName@@ctx.namespaceName@@end if@@if ctx.externalRuntime@ extends TppRuntime@end if@ {
    @emit_java_runtime_members(ctx)@
