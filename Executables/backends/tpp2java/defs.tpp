...
template render_java_enum_body(e: EnumInfo)
    public String _tag;
...
template render_java_enum(e: EnumInfo)
class @e.name@ {
@render_java_enum_body(e)@
END

template render_java_static_enum(e: EnumInfo)
static class @e.name@ {
@render_java_enum_body(e)@
END

template render_java_struct_body(s: StructInfo)
...
template render_java_struct(s: StructInfo)
class @s.name@ {
@render_java_struct_body(s)@
END

template render_java_static_struct(s: StructInfo)
static class @s.name@ {
@render_java_struct_body(s)@
END
...
template render_java_types_body(input: CodegenInput)
@for e in input.enums@
...
template render_java_bundle(input: CodegenInput, ctx: RenderFunctionsInput)
