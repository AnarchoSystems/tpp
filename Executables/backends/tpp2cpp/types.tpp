...
@switch t@
@case Str@std::string@end case@
@case Int@int@end case@
@case Bool@bool@end case@
@case Named(n)@@n@@end case@
@case List(e)@std::vector<@cpp_ir_type(e)@>@end case@
@case Optional(inner)@std::optional<@cpp_ir_type(inner)@>@end case@
@end switch@
END

template cpp_ir_inner_type(t: TypeKind)
@switch t@
@case Optional(inner)@@cpp_ir_type(inner)@@end case@
@case Str@std::string@end case@
@case Int@int@end case@
@case Bool@bool@end case@
@case Named(n)@@n@@end case@
...
template cpp_struct_field_decl(field: CppFieldDef)
@if field.recursive@
...
template cpp_read_field(field: CppFieldDef)
@if field.recursive@
@switch field.type@
@case Optional(inner)@
...
template cpp_write_field(field: CppFieldDef)
@if field.recursive@
@switch field.type@
@case Optional(inner)@
...
@if s.docComment@@s.docComment@@end if@struct @s.name@
{
    @for field in s.fields@
@if field.docComment@@field.docComment@@end if@    @cpp_struct_field_decl(field)@
    @end for@
    static std::string tpp_typedefs() noexcept
    {
...
template render_cpp_types(preStructEnums: list<CppEnumDef>, structs: list<CppStructDef>, postStructEnums: list<CppEnumDef>, includes: list<string>, namespaceName: optional<string>)
#pragma once
@for inc in includes@
#include "@inc@"
@end for@
