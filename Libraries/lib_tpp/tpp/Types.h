...
inline bool operator==(const ListType &a, const ListType &b) { return a.elementType == b.elementType; }
inline bool operator==(const OptionalType &a, const OptionalType &b) { return a.innerType == b.innerType; }
...
inline bool operator==(const FieldDef &a, const FieldDef &b) { return a.name == b.name && a.type == b.type; }
inline bool operator==(const StructDef &a, const StructDef &b) { return a.name == b.name && a.fields == b.fields; }
inline bool operator==(const VariantDef &a, const VariantDef &b) { return a.tag == b.tag && a.payload == b.payload; }
inline bool operator==(const EnumDef &a, const EnumDef &b) { return a.name == b.name && a.variants == b.variants; }
} // namespace tpp::compiler