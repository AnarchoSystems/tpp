...
inline bool operator==(const Variable &a, const Variable &b) { return a.name == b.name; }
inline bool operator==(const FieldAccess &a, const FieldAccess &b) { return a.base == b.base && a.field == b.field; }
inline bool operator==(const Expression &a, const Expression &b) {
    if (a.index() != b.index()) {
        return false;
    }
...
inline bool operator==(const TextNode &a, const TextNode &b) { return a.text == b.text; }
inline bool operator==(const InterpolationNode &a, const InterpolationNode &b) { return a.expr == b.expr && a.policy == b.policy; }
inline bool operator==(const IndentNode &a, const IndentNode &b) { return a.amount == b.amount && a.body == b.body && a.wrapSingleForBody == b.wrapSingleForBody; }
...
inline bool operator==(const FunctionCallNode &a, const FunctionCallNode &b) { return a.functionName == b.functionName && a.arguments == b.arguments; }
...
inline bool operator==(const ParamDef &a, const ParamDef &b) { return a.name == b.name && a.type == b.type; }
inline bool operator==(const TemplateFunction &a, const TemplateFunction &b) { return a.name == b.name && a.params == b.params && a.body == b.body && a.policy == b.policy; }
