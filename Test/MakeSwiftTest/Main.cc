...
static std::string typeKindToSwiftType(const tpp::TypeKind &t, const std::string &namespaceName = "") {
    ...
    case 3:
    {
        return qualifySwiftTypeName(std::get<3>(t.value), namespaceName);
    }
    case 4:
    {
        return "[" + typeKindToSwiftType(*std::get<4>(t.value), namespaceName) + "]";
    }
    case 5:
    {
        return typeKindToSwiftType(*std::get<5>(t.value), namespaceName) + "?";
    }
    default:
    {
        return "Any";
